...
export const testimonials: TestimonialType[] = [
	{
		...
		user: 'Ahamd Ekstrom Bothman',
		username: 'Ahmad',
		picture: '/images/landing/ahmad.png',
	},
	{
		key: 2,
		icon: '/images/landing/gradient-logo.png',
	...
	},
	{
		...
		icon: '/images/landing/gradient-logo.png',
		testimonial:
			"BetterCareer's easy application process allowed me to apply for multiple jobs without repeating information.",
		user: 'Ahamd Ekstrom Bothman',
		username: 'Ahmad',
		picture: '/images/landing/ahmad.png',
	},
	{
		...
		icon: '/images/landing/gradient-logo.png',
		testimonial:
			'As a recent graduate, navigating the job market was overwhelming. BetterCareer provided invaluable guidance every step of the way, ensuring a smooth and stress-free transition into my career.',
		user: 'Ahamd Ekstrom Bothman',
		username: 'Ahmad',
		picture: '/images/landing/ahmad.png',
	},
