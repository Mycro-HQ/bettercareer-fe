...
export const ResumeAnalysisInfo = [
	{
		...
		score: 50,
		problem:
			'The resume layout may be inconsistent or difficult to read, leading to confusion or a negative impression.',
		solutions: [
	...
	},
	{
		...
		score: 50,
		problem:
			'The resume may lack relevant keywords or phrases that align with the job description, potentially leading to it being overlooked by applicant tracking systems (ATS) or recruiters.',
		solutions: [
	...
	},
	{
		...
		score: 50,
		problem:
			"The content of the resume may be too verbose, redundant, or not effectively highlighting the candidate's qualifications and experiences.",
		solutions: [
	...
	},
	{
		...
		score: 50,
		problem:
			"The summary section, if included, may be generic or fail to provide a clear overview of the candidate's qualifications and career objectives.",
		solutions: [
	...
	},
	{
		...
		score: 50,
		problem:
			"The resume may lack quantifiable achievements or results, making it difficult for employers to gauge the candidate's performance and contributions.",
		solutions: [
	...
	},
	{
		...
		score: 50,
		problem:
			"The skills section may be incomplete or fail to adequately showcase the candidate's relevant skills and proficiencies.",
		solutions: [
