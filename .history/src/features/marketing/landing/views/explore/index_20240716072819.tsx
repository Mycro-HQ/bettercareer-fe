...
function ExploreTab2() {
	...
	return (
		<div className="w-full lg:w-[646px] h-auto bg-[#f9fafa] rounded-3xl p-8 overflow-auto">
			{jumbotrons.map((item, index) => (
				<div key={item.key} className="mb-4">
					<div
						className={`flex justify-between items-center p-4 bg-white rounded-lg shadow-md cursor-pointer ${activeIndex === index ? 'bg-gray-100' : ''}`}
