...
export default function Nav() {
	...
	return (
		<section
			className={`${styles.gradientBackground} flex flex-col md:flex-row justify-between items-center w-full py-4 px-6`}
		>
			<Image
			...
			<button className="md:hidden mb-4 md:mb-0" onClick={toggleMenu}>
				<span className="icon-burger-menu"></span>{' '}
				{/* Add a burger icon here */}
			</button>
